 ...
 class Details extends Component {
    ...
    catchInput=(e)=>{
     ...
     saveNewProject=async()=>{
        ...
        let response= await fetch('http://localhost:3457/projects/'+this.props.match.params.id,{
            method:"POST",
        ...
        if(response.ok){
            ...
            let response= await fetch("http://127.0.0.1:3457/projects/"+this.props.match.params.id,{
                headers: new Headers({'content-type': 'application/json'})
            })
    ...
    componentDidMount=async()=>{
        let response= await fetch("http://127.0.0.1:3457/students/"+this.props.match.params.id,{
            headers: new Headers({'content-type': 'application/json'})
        })
        ...
        let response2= await fetch("http://127.0.0.1:3457/projects/"+this.props.match.params.id,{
            headers: new Headers({'content-type': 'application/json'})
        })
