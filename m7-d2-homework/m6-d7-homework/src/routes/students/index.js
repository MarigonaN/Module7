...
router.post("/", async (req, res)=> {
    const response = await db.query(`INSERT INTO "Students" (_id, firstname, surname, email, "dateOfBirth") 
                                     Values ($1, $2, $3, $4, $5)
                                     RETURNING *`, 
                                    [ req.body._id, req.body.firstname, req.body.surname, req.body.email, req.body.dateOfBirth ])
